...
\begin{equation}
	  	\Delta\vec{y}=\Bigg\vert \frac{M\cdot \vec{x}-\vec{y}}{\vec{y}} \Bigg\vert
\end{equation}
...
\end{pmatrix}
	\cdot 10^{-16}
\end{equation}
We can see that the relative error is very small. That means that the solution is very near to the true value of the solution. The needed acccuracy depends on the  aplication of the algorithm. in most cases this algorithm would be sufficient.
